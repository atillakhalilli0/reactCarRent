  ...
  return (
    <div className="w-full lg:w-[85%] xl:w-[70%] mx-auto px-4 md:px-6 py-4 md:py-7 bg-transparent flex flex-col gap-4 md:gap-8">
      <div className="flex flex-col md:flex-row md:justify-between">
        ...
        <ul className={`${menuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-11 text-base font-semibold py-4 md:py-0`}>
          ...
          <li className="flex items-center justify-start md:justify-center border-b-[3px] transition-all duration-[.4s] border-transparent hover:border-black pb-1">
